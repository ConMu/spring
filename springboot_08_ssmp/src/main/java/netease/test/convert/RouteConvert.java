...
public class RouteConvert {
    ...
    public static RouteEntity convert(RouteAo param) {
        ...
        for (String s : param.getEnumValue()) {
            stringBuilder.append(s).append(ACDConfig.SPLIT_REGEX);
        }
        result.setEnumValue(stringBuilder.toString());
    ...
    public static RouteBo convert(RouteEntity entiry) {
        ...
        result.setEnumValue(Arrays.asList(entiry.getEnumValue().split(ACDConfig.SPLIT_REGEX)));
        return result;
    }
    ...
    /**
     * @Description 将旧树构建成Ao对象
     *
     * @Param [routeBo]
     * @return com.netease.we.voip.bs.acd.param.ao.RouteAo
     **/
